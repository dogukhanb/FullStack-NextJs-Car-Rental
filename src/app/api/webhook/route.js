...
// Eğer ödeme başarılı olursa stripe buraya post isteği atıcak bizde ödemenin başarılı olduğunu anlayıp gerekli güncellemeleri yapabil
export async function POST(req) {
  ...
  // 4) ödeme başarılı oluysa satın alınan ürünün verilerine eriş
  if (event.type === "checkout.session.completed") {
    ...
    // kendi veritabanımız  sipariş verisi oluştur
    const orderItem = {
